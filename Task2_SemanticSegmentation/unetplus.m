...
%Whant to know more: https://www.mathworks.com/help/vision/ref/unetlayers.html
lgraph = layerGraph();
...
tempLayers = [
    ...
    convolution2dLayer([1 1],size(tbl,1),"Name","Final-ConvolutionLayer","Padding","same","WeightsInitializer","he")
